...
var gameCore = {
    ...
    loseCount: 0,
    triesLeft: 10,
    wordList: ['DUKE', 'NORTH CAROLINA', 'KANSAS', 'VILLANOVA', 'CONNECTICUT', 'KENTUCKY', 'LOUISVILLE', 'SYRACUSE',], //List of words for game
    imgList: ['duke.jpg', 'north-carolina.jpg', 'kansas.jpg' , 'villanova.jpg' , 'connecticut.jpg' , 'kentucky.jpg' , 'louisville.jpg' , 'syracuse.jpg'], //List image reference
    answers: "",
    imageSrc: "",
    ...
    gameReset: function() {
        ...
        message.textContent = "Name any university that has won an NCAA Men's Basketball Championship in the past 10 Years";
